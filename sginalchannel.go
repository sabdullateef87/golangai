...
// Goroutine 2 is about to send a signal.
// Goroutine 1 is waiting for a signal...
// Goroutine 1 received the signal and is now doing something.
// Goroutine 2 sent the signal.
